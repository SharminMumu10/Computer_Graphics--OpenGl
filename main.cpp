...
void update(int value)
{
    ...
    if((Signal=="red") && (upperCar3<=305 && upperCar3>=285))
    {
        upperCar3_speed=0;
    }
    else
    ...
    if((Signal=="red") && (upperCar2<=504 && upperCar2>=460))
    {
        upperCar2_speed=0;
    }
    else
    ...
    if((Signal=="red") && (upperCar1<=316 && upperCar1>=300))
    {
        upperCar1_speed=0;
    }
    else
    ...
    if((Signal=="red") && (lowerCar1>=160 && lowerCar1<=176))
    {
        lowerCar1_speed=0;
    }
    else
    ...
    if((Signal=="red") && (lowerCar2>=58 && lowerCar2<=82))
    {
        lowerCar2_speed=0;
    }
    else
    ...
    if((Signal=="red") && (lowerCar3>=170 && lowerCar3<=180))
    {
        lowerCar3_speed=0;
    }
    else
    ...
    if(SignalTime>15)
    {
        if(Signal=="red")
        {
            if(SignalTime>30 && VIPsignal=="null")
            {
                Signal="green";
                SignalTime=0;
...
void drawLampPostLight(GLfloat x, GLfloat y, GLfloat radius)
{
    ...
    glColor4f(1.0, 1.0, 1.0-day_night, 1.0);
        ...
        /// triangle fan method to create circle used in lamppost
...
///1st row 1st lamp body
    ...
    glVertex2f(50,130);
    glEnd();
///1st row 2nd lamp head
    glBegin(GL_LINES);
    glColor3f(0.184, 0.310, 0.310);
    glVertex2f(200,130);
    glVertex2f(210,140);
    glEnd();
///1st row 3rd lamp body
...
///2nd row 3rd lamp body
   drawLampPostLight(430,230,3);
    ...
    glEnd();
///2nd row 3rd lamp head
    glBegin(GL_LINES);
    glColor3f(0.184, 0.310, 0.310);
    glVertex2f(400+20,130+95);
    glVertex2f(410+20,140+95);
    glEnd();
///2nd row 4th lamp body
...
///border Between Road and Field
    ...
    glBegin(GL_LINES);/// zebra cross first line
    glColor3f(1,1,1);
    glVertex2f(555,110);
    glVertex2f(555,190);
    glEnd();

    glBegin(GL_LINES);/// zebra cross 2nd line
    glColor3f(1,1,1);
    glVertex2f(575,110);
    glVertex2f(575,190);
    glEnd();

/// zebra cross middle line
    x=115;
    y=125;
    for(int i=0; i<7; i++)
    {
...
///Hill
    ...
    glBegin(GL_POLYGON);
    glColor3f(.9-day_night,0.8-day_night,0.5-day_night);
    if(day=="day")
    {
       glColor3f(.12,.96,1);
    }
  ...
  ///star
    ...
    glBegin(GL_POLYGON);
    glColor3f(0.6-day_night,0.5-day_night,0.1-day_night);
...
int main(int argc, char ** argv)
{
    ...
    glutCreateMenu(MENU);
    glutAddMenuEntry("Stop cars(s)",0);
    glutAddMenuEntry("Run cars(s)",1);
    ...
    glutAddMenuEntry("VIP Signal Deactivate(v)",8);
